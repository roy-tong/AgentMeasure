# AUAS-BIND — Transport & Telemetry Bindings（Draft 0.1）

> **Core protocol 是 vendor-neutral、transport-neutral 的。** 以下是承载 AUAS 的
...
| `_meta` trace context（2026-07-28 正式规范） | trace_id 传播 → Structural match（AUAS-CORR） |
...
2. 绑定的能力边界决定 Profile 的能力矩阵（见 AUAS-PROFILE-*）
