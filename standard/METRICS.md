# AUAS-METRICS — Metric Registry（Draft 0.3）

> **本文件是 AUAS 变更最频繁的文档。** 每个正式指标必须携带完整合同（Metric
...
### AUAS-M2.1 — Presented Opportunities
...
### AUAS-M4.1 — Result Consumed Rate
...
- Task Success Association、Incremental Lift（实验设计见 AUAS 0.5）
